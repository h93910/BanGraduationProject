package com.ban.graduationproject.plugin;
...
public class SwitchView extends View {
	...
	private final AccelerateInterpolator aInterpolator = new AccelerateInterpolator(
			2);
	...
	private boolean intiSet = true;// 新一次设置
